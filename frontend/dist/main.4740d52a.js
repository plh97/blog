!(function(t) {
	...
	85: function(t, e, n) {
		...
		var U = Object(D.combineReducers)({
			...
			G = n(5)
		const Z = E.a.create({ baseURL: void 0 })
		class z {
			...
			async get() {
				return await Z({ url: this.url, method: this.method, data: this.data }).then(
		...
		const V = Object(T.a)(),
			X = Object(k.createLogger)()
		var Q = Object(D.createStore)(
			U,
			Object(S.composeWithDevTools)(Object(D.applyMiddleware)(V, X))
		)
		V.run(function*() {
			yield Object(G.a)([N(), Y(), _(), F(), W(), q()])
		}),
			s.a.render(
				c.a.createElement(u.a, { store: Q }, c.a.createElement(I, null)),
