...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/client/fst/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // import $ from '@pengliheng/jquery';\n\n\n__webpack_require__(/*! ./index.less */ \"./src/client/fst/index.less\");\n\n__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar div = document.createElement('img');\ndiv.src = 'https://user-images.githubusercontent.com/14355994/38042341-b39cb6dc-32e6-11e8-8a28-a184ab9dd8eb.png';\n\ndiv.style.left = '10%';\ndiv.style.top = '81%';\ndocument.body.appendChild(div);\n\nvar Tiao = function () {\n  function Tiao(dom) {\n    _classCallCheck(this, Tiao);\n\n    this.dom = dom;\n    this.step = 0;\n    this.map = [{\n      x: '12', y: '91', to: 'right', func: function func(x) {\n        return 0.02 * x * (68 - x) - 95;\n      }\n    }, {\n      x: '43', y: '80', to: 'right', func: function func(x) {\n        return 0.02 * x * (138 - x) - 157;\n      }\n    }, {\n      x: '74', y: '70', to: 'left', func: function func(x) {\n        return 0.02 * x * (100 - x) - 102;\n      }\n    }, {\n      x: '42', y: '60', to: 'left', func: function func(x) {\n        return 0.02 * x * (52 - x) - 52;\n      }\n    }, {\n      x: '10', y: '53', to: 'right', func: function func(x) {\n        return 0.02 * x * (70 - x) - 55;\n      }\n    }, {\n      x: '42', y: '43', to: 'right', func: function func(x) {\n        return 0.02 * x * (138 - x) - 117;\n      }\n    }, {\n      x: '74', y: '35', to: 'left', func: function func(x) {\n        return 0.02 * x * (96 - x) - 56;\n      }\n    }, {\n      x: '42', y: '25', to: 'left', func: function func(x) {\n        return 0.02 * x * (46 - x) - 10;\n      }\n    }];\n  }\n\n  _createClass(Tiao, [{\n    key: 'moveRight',\n    value: function moveRight() {\n      var _this = this;\n\n      this.dom.style.left = Number(this.dom.style.left.replace(/%/, '')) + 2 + '%';\n      var x = this.dom.style.left.replace(/%/, '');\n      var y = this.map[this.step - 1].func(x);\n      this.dom.style.top = -y + '%';\n      setTimeout(function () {\n        if (_this.dom.style.left.replace(/%/, '') < _this.map[_this.step].x) {\n          _this.moveRight();\n        }\n      }, 20);\n    }\n    // 写的不错，只需要调整末尾数\n\n  }, {\n    key: 'moveLeft',\n    value: function moveLeft() {\n      var _this2 = this;\n\n      this.dom.style.left = Number(this.dom.style.left.replace(/%/, '')) - 2 + '%';\n      var x = this.dom.style.left.replace(/%/, '');\n      var y = void 0;\n      if (this.step === 0) {\n        y = this.map[this.map.length - 1].func(x);\n      } else {\n        y = this.map[this.step - 1].func(x);\n      }\n      this.dom.style.top = -y + '%';\n      setTimeout(function () {\n        if (_this2.dom.style.left.replace(/%/, '') > _this2.map[_this2.step].x) {\n          _this2.moveLeft();\n        }\n      }, 20);\n    }\n  }, {\n    key: 'go',\n    value: function go(_ref) {\n      var step = _ref.step;\n      var to = this.map[this.step].to;\n      // 必须先将步数放在前面\n\n      if (this.step >= this.map.length - 1) {\n        this.step = 0;\n      } else {\n        this.step += step;\n      }\n      if (to === 'right') {\n        this.moveRight();\n      } else if (to === 'left') {\n        this.moveLeft();\n      }\n    }\n  }]);\n\n  return Tiao;\n}();\n\nvar tiao = new Tiao(div);\nvar action = function action(_ref2) {\n  var step = _ref2.step,\n      time = _ref2.time;\n  return new Promise(function (resolve) {\n    setTimeout(function () {\n      tiao.go({ step: step });\n      resolve('');\n    }, time);\n  });\n};\n\nwindow.onload = function () {\n  var loop = function () {\n    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(time) {\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.next = 2;\n              return action({ step: 1, time: time });\n\n            case 2:\n              loop(time);\n\n            case 3:\n            case 'end':\n              return _context.stop();\n          }\n        }\n      }, _callee, undefined);\n    }));\n\n    return function loop(_x) {\n      return _ref3.apply(this, arguments);\n    };\n  }();\n  loop(800);\n};\n\n//# sourceURL=webpack:///./src/client/fst/index.js?");

/***/ }),

/***/ "./src/client/fst/index.less":
/*!***********************************!*\
  !*** ./src/client/fst/index.less ***!
  \***********************************/
/*! no static exports found */
...
eval("// removed by extract-text-webpack-plugin\n\n//# sourceURL=webpack:///./src/client/fst/index.less?");
