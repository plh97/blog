    ...
    return(
        <div class="container-context container">
          ...
          <div class="col-sm-12" id="14">
            ...
            <img src="../build/images/wampzip.png"/>
            <p>后两个文件放在：D:\Program Files (x86)\wamp\bin\php\php5.4.3\ext的路径，然后查看你的本机ip</p>
            <img src="../build/images/benjiip.jpg" />
            <p>然后重启wampserver，直到显示 <img style={{display:'inline'}} src="../build/images/lvsewampserver.jpg"/>,如果你的图标是黄色或者红色，就是说名Apache或者MySQL没有成功开启，如果是Apache没成功开启，可能是80端口被占用，打开控制面板，服务，里面关闭那个占用80端口的服务，然后在开启Apache就可以了，还剩下最后两个步骤，一个是打开你刚才复制进去的httpd-vhosts.conf文件，</p>
            <img src="../build/images/httpd-vhost.jpg"/>
          </div>
          <div class="col-sm-12">
            <p>the last step,我勾上的那些全部要勾上。最上面还有一个php_curl要勾上。</p>
            <img src="../build/images/php_extend.jpg"/>
          ...
          <div class="col-sm-12" id="13">
            <h3>检测是手机端访问本页面还是pc端<i class="icon-mobile-phone"></i></h3>
            <p>先来一首安静的音乐</p>
            <p>然而我暂时还不会写，先放一放</p>
          </div>
          ...
          <div class="col-sm-12" id="11">
            ...
            <img src="../build/images/slidenavHTML.jpg" />
            ...
            <img src="../build/images/QQ截图20151025030302.jpg" />
            <img src="../build/images/slidenav1.jpg" />
...
$('body,html').animate({scrollTop:context_top-100},1000);
          ...
          <div class="col-sm-12" id="10">
            ...
            <img src="../build/images/sdfsdf.jpg" />
            <p>输入Emmet,安装Emmet插件</p>
            <img src="../build/images/QQ截图20151023200832.jpg" />
            <p>接下来出现按照下面的步骤进行</p>
            <img src="../build/images/sublime.jpg" />
            <p>输入ul>li*5,,,然后按crtl+e，自动转化成 <img src="../build/images/sublimedf.jpg" /></p>
            <p>框选一段代码按ctrl+shift+/，便可以更具当前文件自动注释掉当前代码</p>
            <p>将一个文件夹，里面装着各种代码的文件拉入sublime text选择框内，则可出现如下图片，十分方便！</p>
            <img src="../build/images/QQ截图20151023201455.jpg" />
          </div>
          <div class="col-sm-12" id="9">
            ...
            <img src="../build/images/plupload.jpg" />
            <p>红色部分需要添加属于你自己的函数,首先这个插件会将图片上传到后端，然后通过后端传回图片，你通过js调用该图片地址</p>
            <img src="../build/images/plupload_html.jpg"/>
          </div>
          <div class="col-sm-12" id="8">
            ...
            <img src="../build/images/baidu_share.jpg"/>
            <img src="../build/images/baidushare.png" />
          ...
          <div class="col-sm-12" id="6">
            ...
            <img src="../build/images/scss.jpg" />
            <p>怎么样，看完这么简介优秀的代码，是不是心动了，赶紧使用scss吧，css实在是太繁琐了，下面展示两种代码的对比图，怎么样，是不是觉得css弱爆了，而且很难看懂！</p>
            <img src="../build/images/scss_css.jpg" />
          </div>
          <div class="col-sm-12" id="5">
            ...
            <img src="../build/images/github goto settings.jpg"/>
          </div>
          <div class="col-sm-12">
            <img src="../build/images/github add key.jpg"/>
            <p>当即可成功用git链接github了，并且可以成功push你的代码到github上面了！</p>
          </div>
          <div class="col-sm-12" id="4">
            <h3>git 基本命令使用篇</h3>
            ...
            <img src="../build/images/git_init.jpg"/>
            <p>输入git init，新建仓库，也可以clone本地仓库，或者远程仓库</p>
            <img src="../build/images/git_clone.jpg"/>
          </div>
          <div class="col-sm-12">
            ...
            <img src="../build/images/git_address.jpg"/>
          </div>
          <div class="col-sm-12" id="3">
            ...
            <img src="../build/images/github_first.jpg"/>
            <img src="../build/images/github_create_repository.jpg"/>
          </div>
          <div class="col-sm-12">
            <p>Repository name的命名方式必须按照：usernamne.github.io的形式来命名，username用你自己喜欢的网址</p>
            <img src="../build/images/my_github.jpg"/>
            <p>接下来就可以进入到一个这样的页面，点击+进入</p>
            <img src="../build/images/create_index.jpg"/>
          </div>
          <div class="col-sm-12">
          ...
          <div class="col-sm-12" id="2">
            ...
            <img src="../build/images/yumingbuy.jpg"/>
          ...
          <div class="col-sm-12">
            <img src="../build/images/yuming_manage.jpg"/>
            <img src="../build/images/dns_change.jpg"/>
            <p>记得一定要修改成一样的内容。接下来，首先打开<a href="https://www.dnspod.cn/Domain" target="_blank">DNSPOD</a>，接着注册一个帐号</p>
            <img src="../build/images/dnspod_add.jpg"/>
          </div>
          <div class="col-sm-12">
            <p>点击你的域名进入到下面的图片</p>
            <img src="../build/images/dnspod_change.jpg"/>
            ...
            <img src="../build/images/cname.png"/>
          </div>
          <div class="col-sm-12">
            <p>CNAME文件放在项目的根目录上面</p>
            <img src="../build/images/my_production.jpg"/>
