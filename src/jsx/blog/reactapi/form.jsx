...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`<form>
  <label>
    Name:
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`calss NmaeForm extends React.Component {
  constructor(props){
    super(props);
    this.state={value:''}
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`handleChange(event){
  this.setState({value:e.target.value.toUpperCase()});
}
`}</SyntaxHighlighter>
<h4>textarea标签</h4>
<p>在HTML，一个<code>&lt;textarea></code>这样写:</p>
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`<textarea>Hello there, this is some text in a text area</textarea>
`}</SyntaxHighlighter>
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`<select>
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`calss FlavorForm extends React.Component {
  constructor(props){
    super(props);
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`class EssayForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isGoing: true,
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`this.setState({
  [name]:value
})
`}</SyntaxHighlighter>
<p>same to es5 below</p>
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`var partiaState = {};
