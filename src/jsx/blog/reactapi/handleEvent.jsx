  ...
  render() {
    ...
    return (
      <Col span={24}>
        ...
        <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`<button onclick="activateLasers()">
          Active Lasers
        </button>
        `}</SyntaxHighlighter>
        <p>有轻微的不同在React里面</p>
        ...
        <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`<a href="#" onclick="console.log('the link was clicked.'); return false">Click me</a>
        `}</SyntaxHighlighter>
        <p>在react里面，应该这么写</p>
        <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`function ActionLink(){
        ...
        <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`class Toggle extends React.Component{
          constructor(props){
            super(props);
        ...
        <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`class LoggingButton extends React.Component{
