...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const numbers = [1,2,3,4,5];
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`function NumberList(props){
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const todoItems = todos.map((todo) =>
  <li key={todo.id}>
    {todo.text}
  </li>
)
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const todoItems = todos.map((todo,index) =>
  //只做this，如果项目没有合适IDs
...
<h4>例子：不正确的Key用法</h4>
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`function ListItem(props){
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`cont posts = [
...
<SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`function content = posts.map((post) =>
  <Post
    key={post.id}
    id={post.id}
    title={post.title}
