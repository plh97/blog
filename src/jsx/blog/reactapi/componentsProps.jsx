...
ReactDOM.render(
  ...
  document.getElementById('root')
        ...
        <ol type="1">
          <li>我们调用<code className="language-javascript">ReactDOM.render()</code>,里面带有<code className="language-html">&lt;Welcome name="Sara"/></code>元素</li>
          <li>React调用welcome组件，并把<code className="language-html">{`{name:'Sara'}`}</code>当作props。</li>
