...
<Col span={24}>
  ...
  <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`function formatName(user){
  ...
  <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const element = <div tabindex="0"></div>`}</SyntaxHighlighter>
  <p>你也可以将js表达式用花括号包住嵌入到一个属性中</p>
  <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const element = <img src={user.avatarUrl} />`}</SyntaxHighlighter>
  ...
  <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const element = <img src={user.avatarUrl} />`}</SyntaxHighlighter>
  <p>JSX标签也许会包含子标签</p>
  <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const element = (
    <div>
      <h1>hello!</h1>
  ...
  <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`const title = response.pontentiallyMaliciousInput;
  //This is safe;
  ...
  <SyntaxHighlighter showLineNumbers={showLineNumbers} language={language} style={style}>{`//Note:这个结构是简化的
  const element={
    type:'h1',
    props:{
      className:'greeting',
