  ...
  render() {
    return (
      <div>
        ...
        `}</PrismCode>
        <p>接下来，我们将会创造一个组件<code>BoilingVerdict</code>。它渲染一个<code className="language-html">&lt;input/></code>让你输入温度，并且将值保存在<code>this.state.temperature</code>.</p>
        ...
        <p>在react里面，这通常用<code>controlled component</code>来解决，就像DOM元素<code className="language-html">&lt;input/></code>接受同一个<code>value</code>和一个<code>onChange</code>props,所以，可以让<code>Temperatures</code>接受<code>Temperatures</code>和<code>TemperatureInput</code>的props来自于他们的父<code>Calculator</code>。</p>
        ...
        <ul>
        <li>React调用函数在<code className='language-html'>&lt;input></code>的onChange方法。在我们的例子中，这就是<code>TemperatureInput</code>组件中的<code>handleChange</code>方法。</li>
