  ...
  render() {
    return (
      <div>
        ...
        <ol>
          <li>
            <code>FilterableProductTable</code>(orange):包含这个例子的全部。</li>
          <li>
            <code>SearchBar</code>(blue):接受全部用户输入。</li>
          <li>
            <code>ProductTable</code>(green):基于用户输入，显示并且过滤信息收集</li>
          <li>
            <code>ProductCategoryRow</code>(turquoise):显示每个种类的标题。</li>
          <li>
            <code>ProductRow</code>(red):为每个产品显示一行。</li>
        </ol>
